    ...
    <div className="h-dvh flex flex-col">
      ...
      <div className="m-auto flex flex-col w-full max-w-md px-8 sm:px-12 md:px-0 md:w-1/2 lg:w-1/3">
        ...
        <div className="space-y-4 mb-8">
          <p>
            currently @{" "}
            <ExternalLink href="https://www.tilla.tech/">tilla</ExternalLink>
          </p>
        </div>

        {/* Footer */}
        <div className="flex flex-col md:flex-row md:justify-between border-t border-(--border) pt-4 gap-4 md:gap-0 md:items-center mb-8">
